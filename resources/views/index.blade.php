...
<div class="container-details">
    <div>
        <img class="poster" src="{{ asset( 'images/poster.jpeg' ) }}" alt="Poster">
    </div>
        ...
        <div class="content-index">
            <div class="title">
                <h2 class="mt-3">2022 IU CONCERT〈The Golden Hour: Under The
                    Orange Sun〉</h2>
                <p><i class="fa-solid fa-location-dot" style="color: #ffffff; margin-right: 10px"></i>
                    Jamsil Sports Complex - Seoul Olympic Stadium</p>
                <p><i class="fa-regular fa-hourglass" style="color: #ffffff; margin-right: 10px"></i>
            ...
            <div class="mt-4">
                ...
                <div class="d-flex justify-content-center">
                    <img src="{{ asset('images/seatplan.jpg') }}" class="seatplan"></img>
                </div>
            </div>
            <div class="mt-4">
                <h4>Packages</h4>
